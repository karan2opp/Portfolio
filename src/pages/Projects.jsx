...
<div key={index} className={`grid grid-rows-3 w-[90%] sm:w-3/4 md:w-80 rounded-lg  h-36 mt-10 col-span-1 shadow-2xl drop-shadow-[0_0_50px_#171c28] ${Mode ? "" : " hover:bg-[#55198b]"} hover:drop-shadow-[0_0_25px_#686c75] transform transition duration-300 hover:-translate-y-3`}>
